# -*- coding: utf-8 -*-
"""
Created on Wed May 28 20:01:50 2025
...
# Cargar el dataset
df = pd.read_csv("playa_dataset_ext_presMax_dir.csv")

# Seleccionar variables predictoras y objetivo
X = df[["tmax", "wspd", "sol", "presMax", "dir"]].values
...
w_tmax, w_wspd, w_sol, w_presMax, w_dir = svm.coef_[0]
b = svm.intercept_[0]
...
# Mostrar resultados
print(f"Hiperplano: f(x) = {w_tmax:.4f}·tmax + {w_wspd:.4f}·wspd + {w_sol:.4f}·sol + {w_presMax:.4f}·presMax + {w_dir:.4f}·dir + ({b:.4f}) = 0")
